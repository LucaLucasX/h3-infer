...
# Local EXP patch: add 12.0 for RTX 5090 / Blackwell (upstream list lacked it).
...
NVCC_FLAGS = [
    ...
    # Local EXP patch: drop `-include cassert` — double-includes c++config.h on GCC 13 + CUDA 12.8/13.
]
...
for capability in compute_capabilities:
    ...
    if num in ("80", "86", "87"):
        SAGE2PP_ENABLED = False
    # Local EXP patch: Blackwell needs 120a (matches SageAttention setup).
    if num in ("120", "121"):
        num = f"{num}a"
