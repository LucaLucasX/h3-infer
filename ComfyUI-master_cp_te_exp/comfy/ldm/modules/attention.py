...
def attention_pytorch(q, k, v, heads, mask=None, attn_precision=None, skip_reshape=False, skip_output_reshape=False, **kwargs):
    ...
    if SDP_BATCH_LIMIT >= b:
        out = comfy.ops.scaled_dot_product_attention(q, k, v, attn_mask=mask, dropout_p=0.0, is_causal=kwargs.get("is_causal", False), **sdpa_extra)
        ...
        for i in range(0, b, SDP_BATCH_LIMIT):
            ...
            out[i : i + SDP_BATCH_LIMIT] = comfy.ops.scaled_dot_product_attention(
                ...
                attn_mask=m,
                dropout_p=0.0, is_causal=kwargs.get("is_causal", False), **sdpa_extra
